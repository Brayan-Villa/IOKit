/*
<title>iokit/IOKit/IORegistryEntry.h Source</title>
</head><body>
<h1>Source to iokit/IOKit/IORegistryEntry.h</h1>
 ...
 *
 * @<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1f5e4f4f535a4053565c5a514c5a40575a5e5b5a4d404c4b5e4d4b5f">[email&#160;protected]</a>
 * 
 ...
 * under the License.
 * 
 * @<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e8a9b8b8a4adb7a4a1abada6bbadb7a0ada9acadbab7ada6aca8">[email&#160;protected]</a>
 */
/*
...
/*! @function getProperty
    ...
    @param aKey The property's name as a OSymbol.
...
/*! @function getProperty
    @abstract Synchronized method to obtain a property from a registry entry's property table.
    @discussion This method will lookup a property in a registry entry's property table, using the OSDictionary::getObject semantics. This method is synchronized with other IORegistryEntry accesses to the property table.
    @param aKey The property's name as anOSString.
    @result The property value found, or zero. */
