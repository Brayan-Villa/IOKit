/*
<title>iokit/IOKit/usb/IOUSBController.h Source</title>
</head><body>
<h1>Source to iokit/IOKit/usb/IOUSBController.h</h1>
 ...
 *
 * @<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="367766667a73697a7f7573786573697e737772736469656277646276">[email&#160;protected]</a>
 * 
 ...
 * under the License.
 * 
 * @<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a1e0f1f1ede4feede8e2e4eff2e4fee9e4e0e5e4f3fee4efe5e1">[email&#160;protected]</a>
 */
/*
...
#define <a name="_IOKIT_IOUSBCONTROLLER_H" < a><b>_IOKIT_IOUSBCONTROLLER_H</b>
...
} <a name="usbCommand" < a><b>usbCommand</b>;
...
typedef struct {
    ...
    IOReturn		status;
} <a name="IOUSBCommand" < a><b>IOUSBCommand</b>;
...
typedef struct {
    ...
    IOReturn		status;
} <a name="IOUSBIsocCommand" < a><b>IOUSBIsocCommand</b>;
...
struct <a name="ErrataListEntryStruct" < a><b>ErrataListEntryStruct</b> {
    UInt16 				vendID;
    UInt16 				deviceID;
    UInt16 				revisionLo;
    UInt16 				revisionHi;
...
typedef struct ErrataListEntryStruct
                    <a name="ErrataListEntry" < a><b>ErrataListEntry</b>,
                    *<a name="ErrataListEntryPtr" < a><b>ErrataListEntryPtr</b>;

class <a name="IOUSBController" < a><b>IOUSBController</b>;
class <a name="IOUSBDeviceZero" < a><b>IOUSBDeviceZero</b>;
class <a name="IOUSBRootHubDevice" < a><b>IOUSBRootHubDevice</b>;
...
public:
    ...
    */
    struct <a name="Endpoint" < a><b>Endpoint</b> {
...
inline void IOUSBController::<a name="complete" < a><b>complete</b>(IOUSBCompletion	completion,
                                      IOReturn		status,
