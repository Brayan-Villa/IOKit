/*
<title>iokit/IOKit/usb/IOUSBNub.h Source</title>
</head><body>
<h1>Source to iokit/IOKit/usb/IOUSBNub.h</h1>
 ...
 *
 * @<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cd8c9d9d81889281848e88839e889285888c89889f929e998c9f998d">[email&#160;protected]</a>
 * 
...
#define <a name="_IOKIT_IOUSBNUB_H" < a><b>_IOKIT_IOUSBNUB_H</b>
...
class <a name="IOUSBPipe" < a><b>IOUSBPipe</b>;
...
} <a name="IOUSBDevRequest" < a><b>IOUSBDevRequest</b>;
typedef IOUSBDevRequest * <a name="IOUSBDeviceRequestPtr" < a><b>IOUSBDeviceRequestPtr</b>;
...
typedef struct {
    ...
    UInt32	wLenDone;	// # bytes transferred
} <a name="IOUSBDevRequestDesc" < a><b>IOUSBDevRequestDesc</b>;
...
public:
    ...
    */
    struct <a name="FindInterfaceRequest" < a><b>FindInterfaceRequest</b> {
